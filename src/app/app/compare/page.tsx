...
export default function ComparePage() {
  ...
  useEffect(() => {
    ...
    // Ensure revised redline sample is also available for comparison testing
    ...
    // Default select NDA v1 and NDA v2 if available
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-3 items-center">
          <div className="md:col-span-2 space-y-1">
            ...
            <select
              ...
              className="w-full text-xs sm:text-sm p-2.5 border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-slate-900 bg-white"
            >
              {documents.map((d) => (
        ...
        <div className="space-y-8">
          ...
          <div className="bg-slate-900 text-white rounded-lg p-6 space-y-3">
            <div className="flex items-center justify-between flex-wrap gap-2">
              <span className="text-xs uppercase font-semibold text-amber-400 tracking-wider flex items-center gap-1.5">
